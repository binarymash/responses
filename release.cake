    ...
    .Does(() =>
    {
        ...
        NuGetPush(
            ...
            new NuGetPushSettings {
                ApiKey = EnvironmentVariable("myget-apikey-stable"),
                Source = "https://www.myget.org/F/binarymash-stable/api/v2/package"
            });

        NuGetPush(
            "./releaseArtifacts/" + fileLookup["nugetSymbols"],
            new NuGetPushSettings {
                ApiKey = EnvironmentVariable("myget-apikey-stable"),
                Source = "https://www.myget.org/F/binarymash-stable/symbols/api/v2/package"
            });
